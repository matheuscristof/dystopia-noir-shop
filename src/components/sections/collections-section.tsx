...
export const CollectionsSection = () => {
  ...
  return <section id="collections" className="py-20 lg:py-32 relative">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {collections.map((collection, index) => <div key={collection.id} className="group relative overflow-hidden rounded-lg bg-card border border-border hover:border-primary transition-all duration-500" onMouseEnter={() => setHoveredId(collection.id)} onMouseLeave={() => setHoveredId(null)}>
              {/* Image Container */}
              <div className="relative aspect-square overflow-hidden">
                ...
                {hoveredId === collection.id && <div className="absolute inset-0 bg-primary/10 animate-glitch" />}

                {/* Limited Badge */}
                {collection.isLimited && <Badge className="absolute top-4 left-4 bg-destructive text-destructive-foreground animate-neon-pulse">
                    LIMITED
                  </Badge>}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Button variant="secondary" size="sm" className="opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300" asChild>
        ...
        <div className="text-center mt-16">
          <Button size="lg" variant="outline" className="text-lg px-8 py-6 font-mono border-primary text-primary hover:bg-primary hover:text-primary-foreground neon-glow">
